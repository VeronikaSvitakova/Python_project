...
author: Veronika Svitáková
email: svitakovaveronika16@gmail.com
discord: veronikasvitakova
"""
...
def login():
    #overeni zda uzivatel je registrovany
...
def analyze_text(text):
    ...
    sum_of_numbers = sum([int(num) for num in numeric_strings])
    ...
    for length, occurrence in sorted(word_lengths.items()):
        print(f"{length:>3}|{'*' * occurrence:<15}|{occurrence}")
